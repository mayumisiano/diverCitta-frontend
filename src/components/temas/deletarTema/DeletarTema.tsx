...
// se atentar aos caminhos das importações: Model Tema; Service; tokenReducer
                ...
                <Card variant="outlined">
                    <CardContent>
                        <Box justifyContent="center">
                            <Typography color="textSecondary" gutterBottom>Deseja excluir a postagem?</Typography>
